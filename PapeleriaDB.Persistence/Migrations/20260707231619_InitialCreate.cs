        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    EfectivoContado = table.Column<decimal>(type: "TEXT", nullable: false),
                    Diferencia = table.Column<decimal>(type: "TEXT", nullable: false),
                    TotalVendidoTarjeta = table.Column<decimal>(type: "TEXT", nullable: false),
                    TotalVendidoTransferencia = table.Column<decimal>(type: "TEXT", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Estado = table.Column<string>(type: "TEXT", nullable: false),
                    MetodoPagoPrincipal = table.Column<string>(type: "TEXT", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    CostoCompra = table.Column<decimal>(type: "TEXT", precision: 18, scale: 2, nullable: false),
